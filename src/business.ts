...
//
// The file-upload helpers (decodeDataUrl/detectFileType/sanitizeFilename/sanitizeDispositionName)
// moved to src/lib/file-upload.ts once products.ts needed the same magic-byte type detection —
// re-exported here so existing imports of them from this module keep working.
...
export { decodeDataUrl, detectFileType, mimeForFileType, sanitizeFilename, sanitizeDispositionName };
