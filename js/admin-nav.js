...
function aNavById(sec){
  ...
  var titles={dash:'Dashboard',prods:'Product Management',orders:'Orders',custs:'Customers',inv:'Inventory',sales:'Sales Report',subs:'Newsletter Subscribers',blast:'Email Blast',faqs:'FAQs',studio:'Design Studio',reviews:'Reviews',cats:'Categories',shipping:'Shipping Charges',sqpay:'Square Payments',paypalpay:'PayPal Payments',sweep:'Tax Sweep',coupons:'Coupons',reports:'Reports',regtest:'Regression Tests',bizprofile:'Profile',bizdocs:'Documents',bizinv:'Business Inventory',bizreports:'Business Reports',bizequip:'Capital Equipment',emaillog:'Email Log',logs:'Error Logs',settings:'Settings',tncity:'TN City Sales Taxes',gitlog:'Change History',deploylog:'Deploy History',dbbackup:'DB Backup',logout:'Logout'};
